...
bool func_close(aviutl2::raw::INPUT_HANDLE ih);
bool func_info_get(aviutl2::raw::INPUT_HANDLE ih, aviutl2::raw::INPUT_INFO* iip);
int func_read_video(aviutl2::raw::INPUT_HANDLE ih, int frame, void* buf);
int func_read_audio(aviutl2::raw::INPUT_HANDLE ih, int start, int length, void* buf);
...
//---------------------------------------------------------------------
EXTERN_C __declspec(dllexport) aviutl2::raw::INPUT_PLUGIN_TABLE* GetInputPluginTable(void) {
...
bool func_info_get(aviutl2::raw::INPUT_HANDLE ih, aviutl2::raw::INPUT_INFO* iip) {
    ...
    iip->flag = 0;
    if (fp->flag & FILE_HANDLE::FLAG_VIDEO) {
        iip->flag |= aviutl2::raw::INPUT_INFO::FLAG_VIDEO;
    ...
    if (fp->flag & FILE_HANDLE::FLAG_AUDIO) {
        iip->flag |= aviutl2::raw::INPUT_INFO::FLAG_AUDIO;
